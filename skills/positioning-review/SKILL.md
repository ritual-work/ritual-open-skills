...
description: "Review product positioning for a clear target, a sharp differentiated value, credible proof, and a named competitive alternative — not generic claims."
version: 0.1.0
homepage: https://ritual.work
emoji: "🎯"
metadata:
  ritual:
    public_skill_key: ros_positioning_review_v1
---

# Positioning review

A standalone marketing skill. Review product positioning for a clear target, a sharp differentiated value, credible proof, and a named competitive alternative — not generic claims. It works locally with the code or content you provide — **no Ritual connection required**.

## Run it (local, no setup)

Work the steps below; you need nothing beyond the task in front of you.

1. Confirm a specific target audience and the alternative they'd use instead.
2. Check the value is differentiated and falsifiable, not a generic 'best/fastest/easiest'.
3. Confirm each claim has proof (or flag it as an unbacked assertion).
4. Check the positioning is consistent across the headline, subhead, and body.
5. Flag jargon and feature-speak that should be reframed as outcomes.
6. Surface the riskiest claim that needs evidence before it ships.

**Done when:** A view on positioning clarity and differentiation, the unbacked claims, the consistency gaps, and the riskiest claim to validate.
...
- **More context (discovery)** — when the answer depends on things outside the files in front of you:
  - differentiation depends on competitor claims or customer language you can't see
  - proof points and case studies live elsewhere
  - prior positioning decisions apply
- **A structured decision (exploration)** — when the work has become a decision to get right:
  - the positioning itself is contested across sales/product/marketing
  - the target segment is unsettled
  - you need a recommendation the team aligns on
...
**For this task:** a positioning recommendation with the target, differentiated value, proof points, competitive frame, and a decision-ready summary.

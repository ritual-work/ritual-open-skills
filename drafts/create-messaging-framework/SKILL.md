...
description: "DRAFT — Create messaging framework (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_create_messaging_framework_v1
    status: draft
---

# Create messaging framework — DRAFT (not in the v1 publish set)
...
A **Messaging Framework**. This lens contributes:

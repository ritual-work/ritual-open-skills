---
name: instrument-product-metrics
description: "DRAFT — Instrument product metrics (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_instrument_product_metrics_v1
    status: draft
---

# Instrument product metrics — DRAFT (not in the v1 publish set)
...
A **Metrics Spec**. This lens contributes:

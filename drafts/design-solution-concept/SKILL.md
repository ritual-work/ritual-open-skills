---
name: design-solution-concept
description: "DRAFT — Design solution concept (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_design_solution_concept_v1
    status: draft
---

# Design solution concept — DRAFT (not in the v1 publish set)
...
A **Solution Concept Brief**. This lens contributes:
...
*The full deliverable composes 19 sections across every contributing lens.*

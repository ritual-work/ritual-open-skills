...
description: "DRAFT — Build backend service / API (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_build_backend_service_v1
    status: draft
---

# Build backend service / API — DRAFT (not in the v1 publish set)
...
A **Service Build Brief**. This lens contributes:

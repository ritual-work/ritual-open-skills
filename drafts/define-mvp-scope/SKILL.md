...
description: "DRAFT — Define MVP scope (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_define_mvp_scope_v1
    status: draft
---

# Define MVP scope — DRAFT (not in the v1 publish set)
...
A **MVP Scope Brief**. This lens contributes:

---
name: plan-product-iteration
description: "DRAFT — Plan product iteration (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_plan_product_iteration_v1
    status: draft
---

# Plan product iteration — DRAFT (not in the v1 publish set)
...
A **Iteration Brief**. This lens contributes:

...
description: "DRAFT — Define product positioning (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_define_product_positioning_v1
    status: draft
---

# Define product positioning — DRAFT (not in the v1 publish set)
...
A **Positioning Brief**. This lens contributes:

---
name: create-customer-proof
description: "DRAFT — Create customer proof / case study (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_create_customer_proof_v1
    status: draft
---

# Create customer proof / case study — DRAFT (not in the v1 publish set)
...
A **Customer Proof Brief**. This lens contributes:
...
*The full deliverable composes 17 sections across every contributing lens.*

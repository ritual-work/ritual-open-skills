---
name: design-technical-approach
description: "DRAFT — Design technical approach (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_design_technical_approach_v1
    status: draft
---

# Design technical approach — DRAFT (not in the v1 publish set)
...
A **Technical Design Brief**. This lens contributes:

---
name: integrate-api
description: "DRAFT — Integrate external or internal API (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_integrate_api_v1
    status: draft
---

# Integrate external or internal API — DRAFT (not in the v1 publish set)
...
A **Integration Brief**. This lens contributes:

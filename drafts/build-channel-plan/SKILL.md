---
name: build-channel-plan
description: "DRAFT — Build channel plan (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_build_channel_plan_v1
    status: draft
---

# Build channel plan — DRAFT (not in the v1 publish set)
...
A **Channel Plan**. This lens contributes:

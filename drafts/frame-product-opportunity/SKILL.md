---
name: frame-product-opportunity
description: "DRAFT — Frame product opportunity (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_frame_product_opportunity_v1
    status: draft
---

# Frame product opportunity — DRAFT (not in the v1 publish set)
...
A **Opportunity Brief**. This lens contributes:
...
*The full deliverable composes 22 sections across every contributing lens.*

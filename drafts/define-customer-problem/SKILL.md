...
description: "DRAFT — Define customer problem (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_define_customer_problem_v1
    status: draft
---

# Define customer problem — DRAFT (not in the v1 publish set)
...
A **Problem Brief**. This lens contributes:

...
description: "DRAFT — Validate prototype with users (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_validate_prototype_v1
    status: draft
---

# Validate prototype with users — DRAFT (not in the v1 publish set)
...
A **Prototype Validation Brief**. This lens contributes:
...
*The full deliverable composes 15 sections across every contributing lens.*

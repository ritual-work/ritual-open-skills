...
description: "DRAFT — Create documentation site / developer portal (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_build_docs_site_v1
    status: draft
---

# Create documentation site / developer portal — DRAFT (not in the v1 publish set)
...
A **Documentation Site Brief**. This lens contributes:

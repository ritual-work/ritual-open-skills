...
description: "DRAFT — Design growth experiment (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_design_growth_experiment_v1
    status: draft
---

# Design growth experiment — DRAFT (not in the v1 publish set)
...
A **Growth Experiment Brief**. This lens contributes:

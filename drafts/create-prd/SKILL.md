---
name: create-prd
description: "DRAFT — Create PRD (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_create_prd_v1
    status: draft
---

# Create PRD — DRAFT (not in the v1 publish set)
...
*The full deliverable composes 24 sections across every contributing lens.*

---
name: build-spike
description: "DRAFT — Build technical spike (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_build_spike_v1
    status: draft
---

# Build technical spike — DRAFT (not in the v1 publish set)
...
A **Technical Spike Brief**. This lens contributes:

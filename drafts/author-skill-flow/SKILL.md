---
name: author-skill-flow
description: "DRAFT — Author or revise an agent skill flow (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_author_skill_flow_v1
    status: draft
---

# Author or revise an agent skill flow — DRAFT (not in the v1 publish set)
...
A **Feature Specification (Agentic Coding)**. This lens contributes:
...
*The full deliverable composes 21 sections across every contributing lens.*

---
name: refactor-code
description: "DRAFT — Refactor code safely (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_refactor_code_v1
    status: draft
---

# Refactor code safely — DRAFT (not in the v1 publish set)
...
A **Refactor Plan**. This lens contributes:

...
description: "DRAFT — Build frontend feature (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_build_frontend_feature_v1
    status: draft
---

# Build frontend feature — DRAFT (not in the v1 publish set)
...
A **Frontend Feature Brief**. This lens contributes:

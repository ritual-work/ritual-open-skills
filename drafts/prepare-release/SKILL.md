...
description: "DRAFT — Prepare release / deployment (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_prepare_release_v1
    status: draft
---

# Prepare release / deployment — DRAFT (not in the v1 publish set)
...
A **Release Readiness Brief**. This lens contributes:
...
*The full deliverable composes 18 sections across every contributing lens.*

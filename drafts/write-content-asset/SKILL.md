---
name: write-content-asset
description: "DRAFT — Write or refine high-value content asset (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_write_content_asset_v1
    status: draft
---

# Write or refine high-value content asset — DRAFT (not in the v1 publish set)
...
A **Content Asset Brief**. This lens contributes:
...
*The full deliverable composes 20 sections across every contributing lens.*

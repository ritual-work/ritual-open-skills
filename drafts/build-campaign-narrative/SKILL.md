---
name: build-campaign-narrative
description: "DRAFT — Build campaign narrative (pending a standalone local workflow before publish)."
version: 0.1.0
homepage: https://ritual.work
metadata:
  ritual:
    public_skill_key: ros_build_campaign_narrative_v1
    status: draft
---

# Build campaign narrative — DRAFT (not in the v1 publish set)
...
A **Campaign Brief**. This lens contributes:
